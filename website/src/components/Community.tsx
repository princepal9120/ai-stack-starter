const communities = [
    ...
    },
    {
        ...
        description: 'Join us on Twitter for shiposts.',
        href: 'https://twitter.com',
        color: 'bg-sky-500/10 border-sky-500/30 hover:border-sky-500/50'
    }
];
        ...
        <section className="py-24 px-4 bg-slate-900/30">
            <div className="max-w-5xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <p className="text-slate-400">Join our community to get help, share your projects, and even contribute to the project!</p>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    {communities.map((community) => (
                        <a
                            ...
                            className={`block p-6 rounded-xl border transition-colors text-center ${community.color}`}
                        >
